...
import proyecto.subframes.panels.ManageRecordPanel;

import java.awt.*;
import java.util.ArrayList;

public class RecordManagerSubFrame extends javax.swing.JPanel {

    private HomeFrame homePanel;
    private GridLayout gridLayout = new GridLayout(1,1);
    private ArrayList<Record> userRecords;

    public RecordManagerSubFrame() {
        initComponents();
    }

    public RecordManagerSubFrame(HomeFrame homePanel, ArrayList<Record> userRecords) {
        initComponents();
    ...
    private void showUserRecords(){
        ...
        for (Record record : userRecords){
            ManageRecordPanel mrp = new ManageRecordPanel(this, record);
