...
import proyecto.subframes.panels.ApprobationLogPanel;

import java.awt.*;
import java.util.ArrayList;

public class UserRequestsSubFrame extends javax.swing.JPanel {

    private GridLayout gridLayout = new GridLayout(1,1);;
    private ArrayList<Request> userRequests;

    public UserRequestsSubFrame() {
        initComponents();
    }

    public UserRequestsSubFrame(ArrayList<Request> userRequests) {
        initComponents();
    ...
    private void showUserRequests(){
        ...
        for (Request request : userRequests){
            ApprobationLogPanel alp = new ApprobationLogPanel(this, request);
