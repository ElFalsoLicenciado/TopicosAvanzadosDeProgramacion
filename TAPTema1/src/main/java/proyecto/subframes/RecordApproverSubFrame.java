...
public class RecordApproverSubFrame extends javax.swing.JPanel {
    ...
    public RecordApproverSubFrame() {
        initComponents();
    }

    public RecordApproverSubFrame(HomeFrame homePanel, Request request) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnApprove.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/User/Documents/Programming/JetBrains/IntelliJ/TopicosAvanzadosdeProgramacion/TAPTema1/src/main/java/proyecto/resources/aprove.png")
                    );
        ...
        btnDeny.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/User/Documents/Programming/JetBrains/IntelliJ/TopicosAvanzadosdeProgramacion/TAPTema1/src/main/java/proyecto/resources/cancel.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
    ...
    private void btnDenyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDenyMouseClicked
        new WriteReasonSubFrame(this).setVisible(true);
