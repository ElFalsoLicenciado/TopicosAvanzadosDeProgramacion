...
public class ProfileFrame extends javax.swing.JFrame {
    ...
    public ProfileFrame(Usuario usuario) {
        initComponents();
        
        this.usuario = usuario;
        
        jTextField1.setText(usuario.getNombre_completo());
        //jPasswordField1.setText(usuario.getContrasenia());
        
        if(usuario.getFoto() != null) {
            updateFoto(usuario.getFoto());
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        boolean esCambioPass = !jPasswordField1.getText().trim().isEmpty();
        usuario.setNombre_completo(jTextField1.getText());
        ...
        try {
            ...
            if(service.editUsr(usuario, esCambioPass)) {
