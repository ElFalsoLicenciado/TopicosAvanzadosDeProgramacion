...
public class HomePanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuestLayout.setHorizontalGroup(
            ...
            .addGroup(btnGuestLayout.createSequentialGroup()
                .addGap(25, 25, 25)
        ...
        btnGuestLayout.setVerticalGroup(
            btnGuestLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnGuestLayout.createSequentialGroup()
                .addContainerGap(8, Short.MAX_VALUE)
                .addComponent(labelGuest)
                .addContainerGap())
        );
    ...
    private void btnGuestMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuestMouseEntered
        btnGuest.setBackground(new Color(146,246,146));
    ...
    private void btnGuestMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuestMouseExited
        btnGuest.setBackground(new Color(96,243,96));
    ...
    private void fieldPasswordMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fieldPasswordMousePressed
        if (String.valueOf(fieldPassword.getPassword()).equals("123456")){
