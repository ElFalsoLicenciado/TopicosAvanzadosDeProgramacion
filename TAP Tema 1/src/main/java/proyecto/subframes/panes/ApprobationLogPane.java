...
public class ApprobationLogPane extends javax.swing.JPanel {
    ...
    public ApprobationLogPane(UserRequestsPanel userRequestsPanel, Request request) {
        ...
        if (record != null) {
            ...
            if (request.getReason().isEmpty()) labelStatus.setText("Esperando aprobación.");
            else labelStatus.setText(request.getReason());
    ...
    private void initComponents() {
        ...
        add(labelStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, -1, -1));
