...
public class RecordSelectorSubFrame extends javax.swing.JPanel {
    ...
    public RecordSelectorSubFrame() {
        initComponents();
    }

    public RecordSelectorSubFrame(HomeFrame homePanel) {
        initComponents();
        setComboStates();
    ...
    private void showReadableRecords(){
        ...
        for (Record record : records){
            SelectRecordPanel srp = new SelectRecordPanel(this, record);
