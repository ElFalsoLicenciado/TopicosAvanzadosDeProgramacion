...
import proyecto.subframes.RecordApproverSubFrame;
import proyecto.utils.DialogHelper;

import java.awt.Color;
import java.awt.event.KeyEvent;

public class WriteReasonSubFrame extends javax.swing.JFrame {

    RecordApproverSubFrame recordApproverPanel;

    private static final java.util.logging.Logger logger = java.util.logging.Logger.
            getLogger(WriteReasonSubFrame.class.getName());


    public WriteReasonSubFrame() {
        initComponents();
    }

    public WriteReasonSubFrame(RecordApproverSubFrame recordApproverPanel){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new WriteReasonSubFrame().setVisible(
                true));
    }
